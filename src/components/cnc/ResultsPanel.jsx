      ...
      {result.tapping && (
        <div className="rounded-lg border border-border bg-card px-4 py-3 space-y-2.5">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">Tapping Cycle — {result.tapping.threadName} · {result.tapping.holeType === "blind" ? "Blind Hole" : "Through Hole"}</span>
      ...
      {result.drilling && (
        <div className="rounded-lg border border-border bg-card px-4 py-3 space-y-2.5">
          <div className="flex items-center justify-between">
            ...
            <span className="font-mono text-sm font-semibold text-brand">{result.drilling.cycle}</span>
          </div>
          <div className="rounded-md bg-muted px-3 py-2 font-mono text-[11px] leading-relaxed text-foreground overflow-x-auto whitespace-nowrap">
